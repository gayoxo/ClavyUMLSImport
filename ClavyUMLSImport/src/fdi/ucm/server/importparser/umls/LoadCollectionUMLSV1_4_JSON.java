 ...
 *
 */
public class LoadCollectionUMLSV1_4_JSON extends LoadCollectionUMLSV1_0{
	...
	public static void main(String[] args) {
		LoadCollectionUMLSV1 LC=new LoadCollectionUMLSV1_4_JSON();
...
//			
		...
		AA.add(Carpeta+"filter_terms_cmp.json");
