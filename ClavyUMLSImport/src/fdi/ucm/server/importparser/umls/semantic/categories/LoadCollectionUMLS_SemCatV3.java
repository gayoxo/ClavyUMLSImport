 ...
 *
 */
public class LoadCollectionUMLS_SemCatV3 extends LoadCollectionUMLS_SemCatV1{
	...
	public static void main(String[] args) {
		LoadCollectionUMLS_SemCatV3 LC=new LoadCollectionUMLS_SemCatV3();
		LoadCollectionUMLS_SemCatV3.consoleDebug=true;
