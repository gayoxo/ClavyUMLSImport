 ...
 *
 */
public class LoadCollectionUMLSV2_0 extends LoadCollectionUMLSV2{
	...
	public static void main(String[] args) {
		LoadCollectionUMLSV2 LC=new LoadCollectionUMLSV2_0();
		LoadCollectionUMLSV2.consoleDebug=true;
